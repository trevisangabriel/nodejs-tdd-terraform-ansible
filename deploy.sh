...
cd ~/projetos/nodejs-tdd-terraform-ansible/terraform/
~/terraform init
~/terraform validate
...
echo "$(~/projetos/nodejs-tdd-terraform-ansible/terraform/ output | awk '{print $3;exit}')" >> ../ansible/hosts # captura output faz split de espaco e replace de ",
